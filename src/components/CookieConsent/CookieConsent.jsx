        ...
        <div className='flex flex-col md:flex-row items-start md:items-center justify-between gap-4'>
          <div className='flex-1'>
            ...
            <p className='text-xs text-slate-600'>
              ...
              <a
                href='/privacy'
                className='text-excel hover:underline font-medium'
                onClick={(e) => {
                  e.preventDefault();
          ...
          <div className='flex items-center gap-3'>
            ...
            <button
              ...
              className='px-4 py-2 text-sm font-medium text-white bg-excel hover:bg-excel-hover rounded-md transition-colors'
            >
              Accept Cookies
            </button>
          </div>
