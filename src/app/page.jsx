        ...
        >
          ...
          <div className='relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 pt-10 md:pt-14 pb-20 md:pb-28'>
            ...
            <div className='grid md:grid-cols-2 gap-10 lg:gap-16 mb-12 md:mb-16'>
              <div>
                <p className='text-base md:text-lg text-slate-700 leading-relaxed mb-8'>
                  I handle the repetitive stuff: consolidation, reporting, modeling. So your team
                  can focus on what actually matters. Clear scope, fixed price, no surprises.
                </p>
            ...
            <p className='text-sm text-slate-600'>
              Trusted by <strong className='text-slate-900 font-semibold'>500+ businesses</strong>{' '}
              nationwide
            </p>
          </div>
        </section>
            ...
            <div className='grid md:grid-cols-3 gap-6'>
              <div className='card group'>
                ...
                <p className='text-body-base text-slate-600 leading-relaxed mb-6'>
                  Pulling from multiple sources, reformatting, checking formulas, and distributing.
                  The same manual process every period.
                </p>
                <Link
              ...
              <div className='card group'>
                ...
                <p className='text-body-base text-slate-600 leading-relaxed mb-6'>
                  Corruption, slow queries, or multi-user conflicts. When you can't rely on your
                  data, operations suffer.
                </p>
                <Link
              ...
              <div className='card group'>
                ...
                <p className='text-body-base text-slate-600 leading-relaxed mb-6'>
                  Long recalc times, limited scenarios, or formulas that break. Your model should
                  support decisions, not slow them down.
                </p>
                <Link
          ...
          <div className='max-w-7xl mx-auto px-6'>
            <div className='text-center mb-10 md:mb-14'>
              ...
              <p className='text-body-lg text-slate-600 max-w-3xl mx-auto leading-relaxed'>
                Repetitive Excel and Access work goes away; your team gets time back for analysis
                and decisions. Here's what I do.
              </p>
            </div>
        ...
        <section className='py-12 md:py-16 bg-slate-100 text-slate-900 relative overflow-hidden'>
          <div className='relative z-10 max-w-7xl mx-auto px-6 text-center'>
            ...
            <p className='text-body-lg text-slate-700 max-w-2xl mx-auto mb-8 leading-relaxed'>
              Free 30-minute call. We'll look at your process and talk through what can be
              automated. No obligation.
            </p>
