            ...
            <div className='max-w-none'>
              ...
              <div className='prose prose-lg max-w-none text-slate-700 leading-relaxed space-y-6'>
                <p className='text-lg text-slate-700 font-medium'>
                  Financial models drive critical business decisions. A well-built model is
                  accurate, reliable, and easy to understand. A poorly built model leads to bad
                  decisions and costly mistakes. As a{' '}
                  <Link
                  ...
                  , here are the best practices I&apos;ve learned from 15+ years of building
                  financial models for CFOs and controllers.
                </p>
                ...
                <p>
                  ...
                  <strong>Calculations</strong>, and <strong>Outputs</strong>. This makes models
                ...
                <p>
                  ...
                  calculations. Auditors can easily trace formulas. Updates are simple—change
                  inputs, everything else updates automatically.
                </p>
                ...
                <p>
                  Hardcoded values make models brittle and hard to update. Always reference input
                  cells.
                </p>
...
Cost = Revenue * Inputs!B6         ' Margin % from inputs`}
                ...
                <p>
                  <strong>The Rule:</strong> If you find yourself typing a number into a formula,
                  stop. Put it in the inputs sheet and reference it instead.
                </p>
                ...
                <p>
                  Financial models need consistent time periods. Use one row per period (month,
                  quarter, or year) and keep it consistent throughout.
                </p>
                <div className='bg-slate-50 p-6 rounded-lg border border-slate-200 my-6'>
                  <h3 className='text-heading-lg font-bold mb-4 font-display text-slate-900'>
...
Revenue Check:
  =IF(SUM(RevenueByProduct) <> TotalRevenue, "ERROR: Revenue doesn't sum!", "OK")`}
                ...
                <p>
                  <strong>Where to Put Checks:</strong> Create a &quot;Checks&quot; section at the
                  top of your outputs sheet. Use conditional formatting to highlight errors in red.
                </p>
                ...
                <p>
                  Good documentation makes models maintainable. Future you (and others) will thank
                  you.
                </p>
                <div className='bg-slate-50 p-6 rounded-lg border border-slate-200 my-6'>
                  <h3 className='text-heading-lg font-bold mb-4 font-display text-slate-900'>
                  ...
                  <ul className='list-disc list-inside space-y-2 text-slate-700'>
                    <li>
                      <strong>Cover Sheet:</strong> Model purpose, version, last updated, author,
                      key assumptions summary
                    </li>
                    <li>
                      <strong>Input Descriptions:</strong> What each input means, units, valid
                      ranges, data sources
                    </li>
                    <li>
                      <strong>Formula Notes:</strong> Complex formulas should have comments
                    ...
                    <li>
                      <strong>Instructions:</strong> How to use the model, what to update, what not
                      to touch
                    </li>
                  </ul>
                </div>
...
Much clearer!`}
                ...
                <p>
                  <strong>When to Use:</strong> Name all key inputs, key calculations, and key
                  outputs. Don&apos;t overdo it—name the important stuff, not every cell.
                </p>
                ...
                <p>
                  ...
                  cause calculation errors and slow performance.
                </p>
                <div className='bg-excel/10 p-6 rounded-lg border border-excel/20 my-6'>
                  ...
                  <p className='mt-4 text-slate-700'>
                    <strong>Solution:</strong> Break the circle. Calculate iteratively, use goal
                    seek, or restructure the logic to eliminate the dependency.
                  </p>
                </div>
                ...
                <p>
                  Consistent formatting makes models professional and easier to read. Use a color
