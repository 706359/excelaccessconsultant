            ...
            <div className='max-w-none'>
              ...
              <div className='mt-12 bg-slate-100 p-8 rounded-lg border border-slate-200 text-center'>
                ...
                <p className='text-slate-700 mb-6'>
                  Get a free consultation to assess your reporting needs and get a fixed-price quote
                  for automation. Most report automation projects pay for themselves within 3-6
                  months.
                </p>
