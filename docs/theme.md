...
**Secondary Color (Forest Green - Excel):**
- Hex: `#2D7A3E`
- RGB: `rgb(45, 122, 62)`
...
/* Secondary - Forest Green (Excel) */
--secondary: #2D7A3E;        /* Forest Green - Excel-related pages */
--secondary-hover: #1f5a2b;  /* Darker green for hover states */
```
...
**Tailwind Classes:**
```html
<button class="bg-white text-excel border-2 border-excel hover:bg-excel hover:text-white px-6 py-3 rounded-md font-medium">
  Button Text
</button>
```
...
### Phone CTA Button
```html
<a href="tel:8016163702" class="bg-white hover:bg-slate-50 text-excel border-2 border-excel px-8 py-4 rounded-md text-center flex items-center justify-center gap-2">
  <span>📞</span>
...
**Tailwind Classes:**
```html
<div class="bg-white border border-slate-200 rounded-lg p-8 shadow-sm hover:shadow-lg transition-shadow">
  Card Content
</div>
```
...
### Hero Section
```html
<section class="relative w-full h-[600px] md:h-[700px] flex items-center justify-center text-center">
  <!-- Hero content -->
</section>
```
...
<div className='bg-base min-h-screen text-slate-800 font-sans'>
  <button className='bg-excel hover:bg-excel-hover text-white px-6 py-3 rounded-md'>
    Button
  </button>
</div>
```
